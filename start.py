...
komen    = random.choice(
	 ...
	 ['hello bang😎','Keren Suhu','Salam kenal bang♥','Keren anjay','Kelazz','❤','Sehat selalu bang♥','mantap bang😎'])
...
ua = 'Mozilla/5.0 (Linux; U; Android 9; id-id; Infinix X653C Build/PPR1.180610.011) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Linux/61.0.3163.128 Mobile Safari/537.36 XiaoMi/Mint Browser/3.9.3'
...
█▄▄ █▀▄ █▀█ █▄▄ █░█
  ...
  ( PRIBADI [bold green]KALL XD[bold green] ) '''
...
def Masuk():
    ...
    ask = '[bold red]DISARANKAN COKIES HARUS FRESH DAN TIDAK BOLEH AKUN UTAMA !' ; Console(width=60).print(Panel(ask,style='bold green')) ; zprint('[bold green]╭──▸ [bold green]cookies')
...
def menu():
    ...
    Banner() ; time.sleep(0.01) ; exec = (f'[bold green]Selamat datang  tod [bold green]{nama}[bold green], selamat menggunakan') ; Console(width=50).print(Panel(exec,style='bold red'))
...
[bold green][[bold white]0[bold green]]. [bold white]Keluar🤖''') ; Console(width=50).print(Panel(list,style='bold purple'))
    ...
    zprint('[bold green]╭──▸ [bold white]pilih menu')

    assk = console.input('[bold green]╰──▸ [bold green]Yang mana : ')

    if assk in ['1','01']:

          Console(width=50).print(Panel('[bold white]Ketik me jika ingin crack dari daftar teman akun tumbal anda.',style='bold purple'))

          zprint('[bold green╭──▸ [bold green]Pastikan target publik.')

          id = console.input('[bold green╰──▸ [bold green]Masukan userid : ')
...
[bold green][[bold white]3[bold green]]. [bold white]Crack dari ID random''') ; Console(width=50).print(Panel(exec ,style='bold green'))
...
def AturLogin():
    ...
    metod = ('''[bold purple][[bold white]1[bold green]]. [bold white]Crack dari methode reguler

[bold red][[bold white]2[bold green]]. [bold white]Crack dari methode web reguler [bold red]OFF

[bold purple][[bold white]3[bold green]]. [bold white]Crack dari methode validate password ''') ; Console(width=50).print(Panel(metod,style='bold green'))

    zprint('╭──▸ [bold green]jika anda clone email tidak di sarankan memakai validate!')

    z = console.input('╰──▸ [bold green]Pilih : ')
...
[bold green][[bold white]3[bold green]]. [bold white]Crack dari mobile.facebook.com''') ; Console(width=50).print(Panel(exec ,style='bold green'))
